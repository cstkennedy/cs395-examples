...
impl StudentParser {
    ...
    pub fn read_from_text(filename: &str) -> Result<Vec<Student>, ParserError> {
...
impl RosterParser {
    ...
    pub fn read_from_text(filename: &str) -> Result<Vec<EmptyRoster>, ParserError> {
    ...
    ///  * `ins` - input source
    ///
    pub fn read_from_toml(filename: &str) -> Result<Vec<EmptyRoster>, ParserError> {
