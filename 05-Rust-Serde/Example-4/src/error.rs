...
pub enum ParserError {
    ...
    #[error("Length of '{name}' was too short")]
    NameTooShortError { name: String },

    #[error("'{raw_num}' is not a positive number")]
    NotPostiveNumberError { raw_num: String },

    #[error("'{tokens:?}' does not contain exactly 2 entries")]
    WrongNumberOfTokens { tokens: Vec<String> },
}
